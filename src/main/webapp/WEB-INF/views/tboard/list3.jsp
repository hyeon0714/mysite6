			...
			<div id="content">
				...
				<div id="board">
					<div id="list">
						...
						<div id="paging">
							<ul>
								<c:if test="${requestScope.pMap.pre }">
									<li><a href="${pageContext.request.contextPath }/tboard/list3?crtPage=${requestScope.pMap.startPageNo-1}&keyword=${param.keyword}">◀</a></li>
								</c:if>
								<c:forEach begin="${requestScope.pMap.startPageNo }" end="${requestScope.pMap.endPageBtnNo }" step="1" var="page">
									<c:choose>
										<c:when test="${param.crtPage == page || (param.crtPage == null && page==1)}">
